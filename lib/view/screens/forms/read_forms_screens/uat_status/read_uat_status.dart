...
import 'package:pms/view/screens/forms/update_forms_screens/uat_status/update_uat_status.dart';

class Read_UAT_Status extends StatefulWidget {
  const Read_UAT_Status({Key? key}) : super(key: key);

  @override
  State<Read_UAT_Status> createState() => _Read_UAT_StatusState();
}

class _Read_UAT_StatusState extends State<Read_UAT_Status> {
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: Card(
                  ...
                  child: ListTile(
                    onTap: () {
                      Get.to(() => const Update_UAT_Status_Form());
                    },
