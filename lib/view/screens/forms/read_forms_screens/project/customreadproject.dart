...
import 'package:pms/view/screens/forms/update_forms_screens/project/update_project.dart';

class ReadProjectList extends StatelessWidget {
  const ReadProjectList({
    super.key,
    required this.networkApiResponse,
    required this.mediaQuery,
    required this.isDarkMode,
    required this.txtTheme,
  });

  final NetworkApiResponse networkApiResponse;
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) => InkWell(
            onTap: () {
              Get.to(() => const Update_Project_Form());
            },
            child: SizedBox(
              width: 320,
