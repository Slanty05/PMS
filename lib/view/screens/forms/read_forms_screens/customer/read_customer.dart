...
import 'package:pms/view/screens/forms/update_forms_screens/customer/update_customer.dart';

class Read_Customer extends StatefulWidget {
  const Read_Customer({Key? key}) : super(key: key);

  @override
  State<Read_Customer> createState() => _Read_CustomerState();
}

class _Read_CustomerState extends State<Read_Customer> {
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: Card(
                  ...
                  child: ListTile(
                    onTap: () {
                      Get.to(() => const Update_Customer_Form());
                    },
