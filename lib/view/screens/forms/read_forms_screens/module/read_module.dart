...
import 'package:pms/view/screens/forms/update_forms_screens/module/update_module.dart';

class Read_Module extends StatefulWidget {
  const Read_Module({Key? key}) : super(key: key);

  @override
  State<Read_Module> createState() => _Read_ModuleState();
}

class _Read_ModuleState extends State<Read_Module> {
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) => InkWell(
                  onTap: () {
                    Get.to(() => const Update_Module_Form());
                  },
                  child: SizedBox(
                    width: 320,
